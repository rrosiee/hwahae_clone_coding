...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingredient" do
    assert_difference('Ingredient.count') do
      post ingredients_url, params: { ingredient: { good_or_bad: @ingredient.good_or_bad, ingredient_name: @ingredient.ingredient_name } }
    end
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { good_or_bad: @ingredient.good_or_bad, ingredient_name: @ingredient.ingredient_name } }
